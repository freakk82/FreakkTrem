...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright Freakk, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/FreakkTrem-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FreakkTrem-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FreakkTrem-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FreakkTrem-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FreakkTrem-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FreakkTrem-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/FreakkTrem-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/FreakkTrem.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/FreakkTrem.iss",inplace=1):
